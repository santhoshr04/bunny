...
<head>
  ...
  <!-- SEO Meta Tags -->
  <meta name="description" content="Capture the beauty of motherhood with The Bunny Teeth Photography's exciting maternity photoshoots. Our skilled photographers craft timeless, high-quality images that celebrate this special chapter in your life, ensuring every photo tells your story with grace and elegance." />
  <meta name="keywords" content="maternity photography, pregnancy photography, maternity photoshoots, high-quality maternity images, outdoor maternity photos, studio maternity photos, professional maternity photographer, motherhood photography" />
  <meta name="robots" content="index, follow" />
  <meta name="author" content="The Bunny Teeth Photography" />

  <!-- Open Graph Meta Tags (For social sharing) -->
  <meta property="og:title" content="Maternity Photography | The Bunny Teeth Photography" />
  <meta property="og:description" content="Capture the beauty of motherhood with The Bunny Teeth Photography's exciting maternity photoshoots. Our photographers specialize in timeless, high-quality images that celebrate this special chapter in your life." />
  <meta property="og:image" content="{{ asset('storage/services/servicesImg/maternity/main_bg.jpg') }}" />
  ...
  <meta name="twitter:title" content="Maternity Photography | The Bunny Teeth Photography" />
  <meta name="twitter:description" content="Capture the beauty of motherhood with The Bunny Teeth Photography's exciting maternity photoshoots. Our skilled photographers craft timeless, high-quality images to celebrate your journey into motherhood." />
  <meta name="twitter:image" content="{{ asset('storage/services/servicesImg/maternity/main_bg.jpg') }}" />

  <title>Maternity Photography | The Bunny Teeth Photography</title>
...
<body class="custom-scrollbar" style="height: 400px; overflow-y: auto;">
  ...
  <main class="mt-[80px]">
    ...
    <div class="px-5" data-aos="fade-up" data-aos-duration="1000">
      <img class="rounded-2xl" src="{{ asset('storage/services/servicesImg/maternity/main_bg.jpg') }}" alt="baby-bg" />
    </div>
    ...
    <div id="gallery" class="container-fluid mx-auto p-5">
      <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
        ...
        <div class="col-span-1 p-0" data-aos="fade-up" data-aos-duration="1000">
          <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/maternity/portrait1.jpg') }}" alt="" />
        </div>
        ...
        <div class="hidden md:grid md:col-span-1 gap-3">
          <div class="p-0" data-aos="fade-up" data-aos-duration="1000">
            <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/maternity/land1.jpg') }}" alt="" />
          </div>
          <div class="p-0" data-aos="fade-up" data-aos-duration="1000">
            <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/maternity/land2.jpg') }}" alt="" />
          </div>
        </div>

        <!-- Third Column -->
        <div class="col-span-1 p-0" data-aos="fade-up" data-aos-duration="1000">
          <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/maternity/portrait2.jpg') }}" alt="" />
        </div>

        <!-- Landscape Image (visible only on small screens) -->
        <div class="col-span-2 md:hidden" data-aos="fade-up" data-aos-duration="1000">
          <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/maternity/landscape.jpg') }}" alt="" />
        </div>
      </div>
    </div>
    ...
    <div class="py-10" data-aos="fade-up" data-aos-duration="1000">
      ...
      <h3 class="poppins-regular text-center text-lg lg:text-2xl px-[20px] lg:px-20">
        Capture the beauty of motherhood with The Bunny Teeth Photography's
        exciting maternity photoshoots. Our skilled photographers specialize
        in crafting timeless, high-quality images that celebrate this special
        chapter in your life. Whether you prefer a serene outdoor setting or a
        cozy studio backdrop, we cater to your unique vision. Our team's
        expertise in lighting and composition ensures every photo tells your
        story with grace and elegance. Discover the art of maternity
        photography with us, where every image is a cherished memory.
      </h3>
    </div>
  </main>
