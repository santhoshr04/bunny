...
<head>
  ...
  <!-- SEO Meta Tags -->
  <meta name="description" content="Discover a world of diverse photography experiences at The Bunny Teeth Photography. From captivating family portraits to breathtaking landscapes, we capture the essence of your special occasions with creativity and precision. Book your birthday photography session today!" />
  <meta name="keywords" content="birthday photography, special occasion photography, event photography, professional photographers, creative birthday photos, milestone photography, memorable birthday moments, photography services" />
  <meta name="robots" content="index, follow" />
  <meta name="author" content="The Bunny Teeth Photography" />

  <!-- Open Graph Meta Tags (For social sharing) -->
  <meta property="og:title" content="Birthday Photography | The Bunny Teeth Photography" />
  <meta property="og:description" content="Capture the essence of your birthday celebrations with The Bunny Teeth Photography. We offer creative and high-quality birthday photography sessions for unforgettable memories." />
  <meta property="og:image" content="{{ asset('storage/services/servicesImg/otherevents/main_bg.jpg') }}" />
  ...
  <meta name="twitter:title" content="Birthday Photography | The Bunny Teeth Photography" />
  <meta name="twitter:description" content="Celebrate your special day with a professional birthday photography session from The Bunny Teeth Photography. Capture the magic of the moment with stunning, high-quality photos." />
  <meta name="twitter:image" content="{{ asset('storage/services/servicesImg/otherevents/main_bg.jpg') }}" />

  <title>Birthday Photography | The Bunny Teeth Photography</title>
...
<body class="custom-scrollbar" style="height: 400px; overflow-y: auto;">
  ...
  <main class="mt-[80px]">
    ...
    <div class="px-5" data-aos="fade-up" data-aos-duration="1000">
      <img class="rounded-2xl" src="{{ asset('storage/services/servicesImg/otherevents/main_bg.jpg') }}" alt="baby-bg" />
    </div>
    ...
    <div id="gallery" class="container-fluid mx-auto p-5">
      <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
        ...
        <div class="col-span-1 p-0" data-aos="fade-up" data-aos-duration="1000">
          <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/otherevents/portrait1.jpg') }}" alt="" />
        </div>
        ...
        <div class="hidden md:grid md:col-span-1 gap-3">
          <div class="p-0" data-aos="fade-up" data-aos-duration="1000">
            <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/otherevents/land1.jpg') }}" alt="" />
          </div>
          <div class="p-0" data-aos="fade-up" data-aos-duration="1000">
            <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/otherevents/land2.jpg') }}" alt="" />
          </div>
        </div>

        <!-- Third Column -->
        <div class="col-span-1 p-0" data-aos="fade-up" data-aos-duration="1000">
          <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/otherevents/portrait2.jpg') }}" alt="" />
        </div>

        <!-- Landscape Image (visible only on small screens) -->
        <div class="col-span-2 md:hidden" data-aos="fade-up" data-aos-duration="1000">
          <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/otherevents/landscape.jpg') }}" alt="" />
        </div>
      </div>
    </div>
    ...
    <div class="py-10" data-aos="fade-up" data-aos-duration="1000">
      ...
      <h3 class="poppins-regular text-center text-lg lg:text-2xl px-[20px] lg:px-20">
        Discover a world of diverse photography experiences at The Bunny Teeth
        Photography. From captivating family portraits to breathtaking
        landscapes, we're here to capture every moment. Let us capture the
        essence of your special occasions with creativity and precision.
        Explore our portfolio and book your next event with us today.
      </h3>
    </div>
  </main>
