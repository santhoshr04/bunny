...
<head>
  ...
  <!-- SEO Meta Tags -->
  <meta name="description" content="Capture sweet, messy moments with our Cake Smash Photography session at The Bunny Teeth Photography. Watch your little one dive into a cakey adventure, creating unforgettable memories in stunning high-quality photographs. Celebrate your child's milestone in style with our Cake Smash session." />
  <meta name="keywords" content="Cake Smash photography, kids photography, milestone photography, cake smash photoshoot, baby photoshoot, high-quality photography, memorable kids moments, child's milestone" />
  <meta name="robots" content="index, follow" />
  <meta name="author" content="The Bunny Teeth Photography" />

  <!-- Open Graph Meta Tags (For social sharing) -->
  <meta property="og:title" content="Cake Smash Photography | The Bunny Teeth Photography" />
  <meta property="og:description" content="Celebrate your child's milestone in style with a Cake Smash session at The Bunny Teeth Photography. Capture the messy, fun, and sweet moments of your little one diving into a cake!" />
  <meta property="og:image" content="{{ asset('storage/services/servicesImg/cakesmash/main_bg.jpg') }}" />
  ...
  <meta name="twitter:title" content="Cake Smash Photography | The Bunny Teeth Photography" />
  <meta name="twitter:description" content="Capture sweet, messy moments with our Cake Smash Photography session at The Bunny Teeth Photography. Celebrate your child's milestone in style with high-quality photographs." />
  <meta name="twitter:image" content="{{ asset('storage/services/servicesImg/cakesmash/main_bg.jpg') }}" />

  <title>Cake Smash Photography | The Bunny Teeth Photography</title>
  ...
  <main class="mt-[80px]">
    ...
    <div class="py-10" data-aos="fade-up" data-aos-duration="1000">
      ...
      <h3 class="poppins-regular text-center text-lg lg:text-2xl px-[20px] lg:px-20">
        Capture sweet, messy moments with our Cake Smash Photography session
        at The Bunny Teeth Photography. Watch your little one dive into a
        cakey adventure, creating unforgettable memories in stunning
        high-quality photographs. Our skilled photographers ensure every
        giggle, frosting-covered smile, and icing-covered hand is beautifully
        preserved. Celebrate your child's milestone in style with our Cake
        Smash session today.
      </h3>
    </div>
  </main>
