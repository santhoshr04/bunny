...
<head>
  ...
  <!-- font awesome -->
  <script
    src="https://kit.fontawesome.com/c0fbdcbfe4.js"
...
<body class="custom-scrollbar" style="height: 400px; overflow-y: auto;">
    ...
    <nav class="bg-white shadow-sm fixed top-0 w-full z-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20 items-center">
          ...
          <div class="hidden md:flex items-center space-x-10 poppins-regular">
            ...
            <a href="../../index.html#about" class="text-gray-500 hover:text-gray-900 px-1 py-2 text-md font-medium">About us</a>
            <a href="../../services" class="text-gray-900 border-b-2 border-amber-500 px-1 py-2 text-md font-medium">Services</a>
            <a href="../../index.html#gallery" class="text-gray-500 hover:text-gray-900 px-1 py-2 text-md font-medium">Gallery</a>
            <a href="../../index.html#contact" class="text-gray-500 hover:text-gray-900 px-1 py-2 text-md font-medium">Contact Us</a>
          </div>
      ...
      <div id="mobile-menu" class="hidden md:hidden">
        <div class="px-3 pt-2 pb-3 space-y-1 poppins-regular text-center">
          <a href="../../index.html" class="text-gray-500 hover:text-gray-900 block px-3 py-2 text-base font-medium border-b">Home</a>
          <a href="../../index.html#about" class="text-gray-500 hover:text-gray-900 block px-3 py-2 text-base font-medium border-b">About us</a>
          <a href="../../services" class="text-gray-900 block px-3 py-2 text-base font-medium border-b">Services</a>
          <a href="../../index.html#gallery" class="text-gray-500 hover:text-gray-900 block px-3 py-2 text-base font-medium border-b">Gallery</a>
          <a href="../../index.html#contact" class="text-gray-500 hover:text-gray-900 block px-3 py-2 text-base font-medium">Contact Us</a>
  ...
  <main class="mt-[80px]">
    ...
    <div class="px-5" data-aos="fade-up" data-aos-duration="1000">
      <img
        class="rounded-2xl"
        src="../../Images/services/baby/main_bg.jpg"
        alt="baby-bg" />
    </div>
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
        ...
        <div class="col-span-1 p-0" data-aos="fade-up" data-aos-duration="1000">
          <img
            ...
            src="../../Images/services/baby/portrait1.jpg"
            alt="" />
        </div>
        ...
        <div class="hidden md:grid md:col-span-1 gap-3">
          <div class="p-0" data-aos="fade-up" data-aos-duration="1000">
            <img
              class="rounded-xl w-full h-auto"
              src="../../Images/services/baby/land1.jpg"
              alt="" />
          </div>
          <div class="p-0" data-aos="fade-up" data-aos-duration="1000">
            <img
              class="rounded-xl w-full h-auto"
              src="../../Images/services/baby/land2.jpg"
              alt="" />
          </div>
        </div>
        ...
        <div class="col-span-1 p-0" data-aos="fade-up" data-aos-duration="1000">
          <img
            class="rounded-xl w-full h-auto"
            src="../../Images/services/baby/portrait2.jpg"
            alt="" />
        </div>
        ...
        <div class="col-span-2 md:hidden" data-aos="fade-up" data-aos-duration="1000">
          <img
            class="rounded-xl w-full h-auto"
            src="../../Images/services/baby/landscape.jpg"
            alt="" />
        </div>
      </div>
    </div>
  ...
  <footer class="p-2 mt-5 lg:mt-10">
    <div class="h-full p-6 md:p-10 bg-black/90 rounded-xl">
      <div
        ...
        <div>
          <p
            class="text-sm lg:text-base 2xl:text-2xl poppins-regular text-white my-2 ">
            <i class="fa-solid fa-phone mr-2"></i> +91 78249 99900
          </p>
          <p
            class="text-sm lg:text-base 2xl:text-2xl poppins-regular text-white my-6">
            <i class="fa-solid fa-envelope mr-2"></i> hello@thebunnyteethphotography.com
          </p>
          <p
            class="text-sm lg:text-base xl:text-2xl poppins-regular text-white my-2">
        ...
        <div>
          <p
            class="hidden md:block text-end text-base lg:text-2xl xl:text-2xl poppins-regular text-white">
