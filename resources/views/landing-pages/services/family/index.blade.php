...
<head>
  ...
  <!-- SEO Meta Tags -->
  <meta name="description" content="Capture cherished moments with high-quality family photography services at The Bunny Teeth Photography. Our professional photographers specialize in creating beautiful family portraits, from candid shots to posed group photos, both indoor and outdoor." />
  <meta name="keywords" content="family photography, indoor family photos, outdoor family photos, family portraits, professional family photographer, high-quality family photography, family photography services, family photoshoots" />
  <meta name="robots" content="index, follow" />
  <meta name="author" content="The Bunny Teeth Photography" />

  <!-- Open Graph Meta Tags (For social sharing) -->
  <meta property="og:title" content="Family Photography | The Bunny Teeth Photography" />
  <meta property="og:description" content="Capture cherished moments with high-quality family photography services at The Bunny Teeth Photography. We specialize in creating beautiful family portraits, from candid shots to posed group photos, both indoor and outdoor." />
  <meta property="og:image" content="{{ asset('storage/services/servicesImg/family/main_bg.jpg') }}" />
  ...
  <meta name="twitter:title" content="Family Photography | The Bunny Teeth Photography" />
  <meta name="twitter:description" content="Capture cherished moments with high-quality family photography services at The Bunny Teeth Photography. Our photographers specialize in creating beautiful family portraits, both indoor and outdoor." />
  <meta name="twitter:image" content="{{ asset('storage/services/servicesImg/family/main_bg.jpg') }}" />

  <title>Family Photography | The Bunny Teeth Photography</title>
...
<body class="custom-scrollbar" style="height: 400px; overflow-y: auto;">
  ...
  <main class="mt-[80px]">
    ...
    <div class="px-5" data-aos="fade-up" data-aos-duration="1000">
      <img class="rounded-2xl" src="{{ asset('storage/services/servicesImg/family/main_bg.jpg') }}" alt="baby-bg" />
    </div>
    ...
    <div id="gallery" class="container-fluid mx-auto p-5">
      <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
        ...
        <div class="col-span-1 p-0" data-aos="fade-up" data-aos-duration="1000">
          <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/family/portrait1.jpg') }}" alt="" />
        </div>
        ...
        <div class="hidden md:grid md:col-span-1 gap-3">
          <div class="p-0" data-aos="fade-up" data-aos-duration="1000">
            <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/family/land1.jpg') }}" alt="" />
          </div>
          <div class="p-0" data-aos="fade-up" data-aos-duration="1000">
            <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/family/land2.jpg') }}" alt="" />
          </div>
        </div>

        <!-- Third Column -->
        <div class="col-span-1 p-0" data-aos="fade-up" data-aos-duration="1000">
          <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/family/portrait2.jpg') }}" alt="" />
        </div>

        <!-- Landscape Image (visible only on small screens) -->
        <div class="col-span-2 md:hidden" data-aos="fade-up" data-aos-duration="1000">
          <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/family/landscape.jpg') }}" alt="" />
        </div>
      </div>
    </div>
    ...
    <div class="py-10" data-aos="fade-up" data-aos-duration="1000">
      <h1 class="poppins-medium text-md lg:text-xl py-5 yellow-text text-center">
        FAMILY PHOTOGRAPHY (INDOOR & OUTDOOR)
      </h1>
      <h3 class="poppins-regular text-center text-lg lg:text-2xl px-[20px] lg:px-20">
        Capture cherished moments with our high-quality family photography
        services. At The Bunny Teeth Photography, we specialize in creating
        beautiful family portraits. From candid shots to posed group photos,
        we've got your family's unique style covered. Our professional
        photographers have the expertise to make your family shine in every
        frame. Let us craft unforgettable memories that will last a lifetime.
      </h3>
    </div>
  </main>
