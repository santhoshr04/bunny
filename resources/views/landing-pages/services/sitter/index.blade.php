...
<head>
  ...
  <!-- SEO Meta Tags -->
  <meta name="description" content="Capture your little one's adorable milestones during the 7-12 month phase with The Bunny Teeth Photography. Our skilled photographers create high-quality portraits that freeze precious moments in time, helping you cherish every stage of your baby's growth." />
  <meta name="keywords" content="sitter photography, baby photography, 7-12 months photography, milestone photography, high-quality portraits, professional photographer, baby portraits" />
  <meta name="robots" content="index, follow" />
  <meta name="author" content="The Bunny Teeth Photography" />

  <!-- Open Graph Meta Tags (For social sharing) -->
  <meta property="og:title" content="SITTER Photography | The Bunny Teeth Photography" />
  <meta property="og:description" content="Capture your little one's adorable milestones during the 7-12 month phase with The Bunny Teeth Photography. Specializing in high-quality portraits that freeze precious moments in time." />
  <meta property="og:image" content="{{ asset('storage/services/servicesImg/sitter/main_bg.jpg') }}" />
  ...
  <meta name="twitter:title" content="SITTER Photography | The Bunny Teeth Photography" />
  <meta name="twitter:description" content="Capture your little one's adorable milestones during the 7-12 month phase with The Bunny Teeth Photography. Our skilled photographers specialize in creating high-quality portraits that freeze precious moments in time." />
  <meta name="twitter:image" content="{{ asset('storage/services/servicesImg/sitter/main_bg.jpg') }}" />

  <title>SITTER Photography | The Bunny Teeth Photography</title>
...
<body class="custom-scrollbar" style="height: 400px; overflow-y: auto;">
  ...
  <main class="mt-[80px]">
    ...
    <div class="px-5" data-aos="fade-up" data-aos-duration="1000">
      <img class="rounded-2xl" src="{{ asset('storage/services/servicesImg/sitter/main_bg.jpg') }}" alt="baby-bg" />
    </div>
    ...
    <div id="gallery" class="container-fluid mx-auto p-5">
      <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
        ...
        <div class="col-span-1 p-0" data-aos="fade-up" data-aos-duration="1000">
          <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/sitter/portrait1.jpg') }}" alt="" />
        </div>
        ...
        <div class="hidden md:grid md:col-span-1 gap-3">
          <div class="p-0" data-aos="fade-up" data-aos-duration="1000">
            <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/sitter/land1.jpg') }}" alt="" />
          </div>
          <div class="p-0" data-aos="fade-up" data-aos-duration="1000">
            <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/sitter/land2.jpg') }}" alt="" />
          </div>
        </div>

        <!-- Third Column -->
        <div class="col-span-1 p-0" data-aos="fade-up" data-aos-duration="1000">
          <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/sitter/portrait2.jpg') }}" alt="" />
        </div>

        <!-- Landscape Image (visible only on small screens) -->
        <div class="col-span-2 md:hidden" data-aos="fade-up" data-aos-duration="1000">
          <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/sitter/landscape.jpg') }}" alt="" />
        </div>
      </div>
    </div>
    ...
    <div class="py-10" data-aos="fade-up" data-aos-duration="1000">
      ...
      <h3 class="poppins-regular text-center text-lg lg:text-2xl px-[20px] lg:px-20">
        Capture your little one's adorable milestones during the 7-12 month
        phase with The Bunny Teeth Photography. Our skilled photographers
        specialize in creating high-quality portraits that freeze those
        precious moments in time. From playful giggles to budding
        personalities, we'll help you cherish every stage of your baby's
        growth. Explore our gallery for a glimpse of our artistry.
      </h3>
    </div>
  </main>
