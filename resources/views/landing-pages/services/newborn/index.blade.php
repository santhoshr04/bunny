...
<head>
  ...
  <!-- SEO Meta Tags -->
  <meta name="description" content="Capture the pure essence of your newborn (6-40 days old) with expert photography services at The Bunny Teeth Photography. High-quality photoshoots preserve your baby's innocence, charm, and the magical moments of their early days." />
  <meta name="keywords" content="newborn photography, baby photography, 6-40 days old, high-quality newborn photoshoots, professional newborn photographer, newborn portraits, baby candid shots, early moments photography" />
  <meta name="robots" content="index, follow" />
  <meta name="author" content="The Bunny Teeth Photography" />

  <!-- Open Graph Meta Tags (For social sharing) -->
  <meta property="og:title" content="Newborn Photography | The Bunny Teeth Photography" />
  <meta property="og:description" content="Capture the pure essence of your newborn (6-40 days old) with expert photography services at The Bunny Teeth Photography. Our high-quality photoshoots immortalize those precious early moments and create lasting memories." />
  <meta property="og:image" content="{{ asset('storage/services/servicesImg/newborn/main_bg.jpg') }}" />
  ...
  <meta name="twitter:title" content="Newborn Photography | The Bunny Teeth Photography" />
  <meta name="twitter:description" content="Capture the pure essence of your newborn (6-40 days old) with expert photography services at The Bunny Teeth Photography. Our high-quality photoshoots immortalize those precious early moments." />
  <meta name="twitter:image" content="{{ asset('storage/services/servicesImg/newborn/main_bg.jpg') }}" />

  <title>Newborn Photography | The Bunny Teeth Photography</title>
...
<body class="custom-scrollbar" style="height: 400px; overflow-y: auto;">
  ...
  <main class="mt-[80px]">
    ...
    <div class="px-5" data-aos="fade-up" data-aos-duration="1000">
      <img class="rounded-2xl" src="{{ asset('storage/services/servicesImg/newborn/main_bg.jpg') }}" alt="baby-bg" />
    </div>
    ...
    <div id="gallery" class="container-fluid mx-auto p-5">
      <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
        ...
        <div class="col-span-1 p-0" data-aos="fade-up" data-aos-duration="1000">
          <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/newborn/portrait1.jpg') }}" alt="" />
        </div>
        ...
        <div class="hidden md:grid md:col-span-1 gap-3">
          <div class="p-0" data-aos="fade-up" data-aos-duration="1000">
            <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/newborn/land1.jpg') }}" alt="" />
          </div>
          <div class="p-0" data-aos="fade-up" data-aos-duration="1000">
            <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/newborn/land2.jpg') }}" alt="" />
          </div>
        </div>

        <!-- Third Column -->
        <div class="col-span-1 p-0" data-aos="fade-up" data-aos-duration="1000">
          <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/newborn/portrait2.jpg') }}" alt="" />
        </div>

        <!-- Landscape Image (visible only on small screens) -->
        <div class="col-span-2 md:hidden" data-aos="fade-up" data-aos-duration="1000">
          <img class="rounded-xl w-full h-auto" src="{{ asset('storage/services/servicesImg/newborn/landscape.jpg') }}" alt="" />
        </div>
      </div>
    </div>
    ...
    <div class="py-10" data-aos="fade-up" data-aos-duration="1000">
      ...
      <h3 class="poppins-regular text-center text-lg lg:text-2xl px-[20px] lg:px-20">
        Capture the pure essence of your newborn (6-40 days old) with our
        expert photography services at The Bunny Teeth Photography. Our
        high-quality photoshoots will immortalize those precious early
        moments, preserving your baby's innocence and charm. From adorable
        candid shots to artistic compositions, we craft visual stories that
        celebrate this magical stage of life. Cherish your baby's first days
        forever with our professional newborn photography.
      </h3>
    </div>
  </main>
