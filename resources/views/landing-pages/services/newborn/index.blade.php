...
<body class="custom-scrollbar" style="height: 400px; overflow-y: auto;">
  ...
  <main class="mt-[80px]">
    ...
    <div class="px-5" data-aos="fade-up" data-aos-duration="1000">
      <img class="rounded-2xl" src="../../Images/services/newborn/main_bg.jpg" alt="baby-bg" />
    </div>
    ...
    <div id="gallery" class="container-fluid mx-auto p-5">
      <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
        ...
        <div class="col-span-1 p-0" data-aos="fade-up" data-aos-duration="1000">
          <img class="rounded-xl w-full h-auto" src="../../Images/services/newborn/portrait1.jpg" alt="" />
        </div>
        ...
        <div class="hidden md:grid md:col-span-1 gap-3">
          <div class="p-0" data-aos="fade-up" data-aos-duration="1000">
            <img class="rounded-xl w-full h-auto" src="../../Images/services/newborn/land1.jpg" alt="" />
          </div>
          <div class="p-0" data-aos="fade-up" data-aos-duration="1000">
            <img class="rounded-xl w-full h-auto" src="../../Images/services/newborn/land2.jpg" alt="" />
          </div>
        </div>

        <!-- Third Column -->
        <div class="col-span-1 p-0" data-aos="fade-up" data-aos-duration="1000">
          <img class="rounded-xl w-full h-auto" src="../../Images/services/newborn/portrait2.jpg" alt="" />
        </div>

        <!-- Landscape Image (visible only on small screens) -->
        <div class="col-span-2 md:hidden" data-aos="fade-up" data-aos-duration="1000">
          <img class="rounded-xl w-full h-auto" src="../../Images/services/newborn/landscape.jpg" alt="" />
        </div>
      </div>
    </div>
